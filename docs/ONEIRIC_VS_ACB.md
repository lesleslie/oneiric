...
## status: active role: canonical date: 2026-01-21 last_reviewed: 2026-07-17 superseded_by: null blocks_on: [] topic: adapter-architecture
...
- ✅ Async-first (Python 3.13, 3.14 planned)
...
- ⚠️ v0.3.3 (recent release; audit in v0.2.0)
