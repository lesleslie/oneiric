...
- Record CLI snapshots (command + JSON output) alongside Crackerjack reports in PRs so reviewers can see the migration state; this mirrors the expectations documented in `../acb`, `../crackerjack`, and `../fastblocks`.
