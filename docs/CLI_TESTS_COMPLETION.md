...
2. ✅ Demo provider registration via `--demo` flag
3. ✅ Module import via `--import` flag
4. ✅ Help text display without subcommand
5. ✅ Domain normalization (case-insensitive)
6. ✅ Invalid domain rejection

### List Command
1. ✅ Lists active candidates for all 5 domains
2. ✅ Shows shadowed candidates with `--shadowed`
3. ✅ Works without demo providers
4. ✅ Works with demo providers
5. ✅ Rejects invalid domain names

### Explain Command
1. ✅ Outputs resolution explanation for adapters
2. ✅ Outputs resolution explanation for services
3. ✅ Handles unresolved keys gracefully
4. ✅ Outputs to stdout (JSON format)

### Swap Command
1. ✅ Performs lifecycle swap for domain keys
2. ✅ Accepts provider override
3. ✅ Accepts force flag
4. ✅ Returns swapped instance info

### Pause Command
1. ✅ Marks domain key as paused
2. ✅ Accepts note parameter
3. ✅ Resumes with `--resume` flag
4. ✅ Persists activity state

### Drain Command
1. ✅ Marks domain key as draining
2. ✅ Accepts note parameter
3. ✅ Clears with `--clear` flag
4. ✅ Persists draining state

### Status Command
1. ✅ Shows domain-level status
2. ✅ Accepts key filter
3. ✅ Outputs JSON with `--json`
4. ✅ Shows shadowed details with `--shadowed`
5. ✅ Includes remote telemetry
6. ✅ Shows lifecycle state
7. ✅ Shows activity state (pause/drain)

### Health Command
1. ✅ Shows lifecycle health snapshots
2. ✅ Accepts domain filter
3. ✅ Accepts key filter
4. ✅ Outputs JSON with `--json`
5. ✅ Runs live probes with `--probe`
6. ✅ Includes runtime health snapshot
...
2. ✅ Handles empty telemetry
3. ✅ Outputs JSON with `--json`
4. ✅ Shows last success/failure timestamps

### Remote Sync Command
1. ✅ Syncs from manifest file
2. ✅ Handles manifest URL override
