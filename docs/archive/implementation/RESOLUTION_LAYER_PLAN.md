...
> **Archive Notice (2025-12-19):** Superseded by `docs/RESOLUTION_LAYER_SPEC.md` and the Stage 5 audit.
...
- Discovery inputs:
  ...
  - Entry-point scan (implemented via `oneiric.plugins`).
- Registration:
...
1. Optional: OCI artifacts, MCP registry integration.
