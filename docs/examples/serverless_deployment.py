...
async def main() -> None:
    ...
    print()
    print("   ✓ Render deployment config overlay")
    print("     uv run python scripts/render_deploy_config.py \\")
    print("       --base config/standard.yaml \\")
    print("       --overlay deploy.yaml \\")
    print("       --output config/serverless.yaml")
    print("     # or: make deploy-config")
    print()
    ...
    print("     ONEIRIC_PROFILE=serverless")
    print("     ONEIRIC_CONFIG=/workspace/config/serverless.yaml")
    ...
    print("10. Example serverless config (config/serverless.yaml):")
    print()
    print("    app:")
    ...
    print()
    print("    runtime_paths:")
    print("      workflow_checkpoints_enabled: true")
    print()
    print("    runtime_supervisor:")
    print("      enabled: true")
    ...
    print("      inline_manifest_only: true")
    print()
