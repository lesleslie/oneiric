...
## status: complete role: historical date: 2026-02-17 last_reviewed: 2026-07-17 superseded_by: null blocks_on: [] topic: oneiric-config
...
- ONEIRIC\_ prefix still works as default
...
- ONEIRIC\_ environment variable prefix still works as default
...
1. Update README with XDG config examples
1. Create example XDG config files
...
1. ✅ `/Users/les/Projects/oneiric/tests/core/test_config_xdg.py`
