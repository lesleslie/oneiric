...
class TestEventDispatcher:
    ...
    def test_dispatch_event_success(self, dispatcher, sample_listener):
        ...
        payload = EventPayload(
            topic="test.events", data={"message": "test"}, timestamp=datetime.now()
        )
    ...
    def test_dispatch_event_no_listeners(self, dispatcher):
        ...
        payload = EventPayload(
            topic="empty.events", data={"message": "test"}, timestamp=datetime.now()
        )
    ...
    def test_dispatch_with_filter(self, dispatcher):
        ...
        payload1 = EventPayload(
            topic="filtered.events", data={"enabled": False}, timestamp=datetime.now()
        )
        ...
        payload2 = EventPayload(
            topic="filtered.events", data={"enabled": True}, timestamp=datetime.now()
        )
    ...
    def test_dispatch_with_retry_policy(self, dispatcher):
        ...
        payload = EventPayload(
            topic="retry.events", data={"message": "test"}, timestamp=datetime.now()
        )
    ...
    def test_dispatch_fan_out_all(self, dispatcher):
        ...
        payload = EventPayload(topic="fanout.events", data={}, timestamp=datetime.now())
    ...
    def test_dispatch_fan_out_first(self, dispatcher):
        ...
        payload = EventPayload(topic="first.events", data={}, timestamp=datetime.now())
    ...
    def test_dispatch_async(self, dispatcher):
        ...
        payload = EventPayload(topic="async.events", data={}, timestamp=datetime.now())
    ...
    def test_get_topic_stats(self, dispatcher):
        ...
        payload = EventPayload(topic="stats.events", data={}, timestamp=datetime.now())
        dispatcher.dispatch(payload)
...
class TestEventListener:
    ...
    def test_listener_creation(self):
        ...
        listener = EventListener(
            name="test_listener", handler=handler, topic="test.events"
        )
    ...
    def test_listener_execution(self):
        ...
        listener = EventListener(
            name="exec_listener", handler=handler, topic="test.events"
        )
    ...
    def test_listener_with_timeout(self):
        ...
        payload = EventPayload(topic="test.events", data={}, timestamp=datetime.now())
    ...
    def test_listener_error_handling(self):
        ...
        listener = EventListener(
            name="error_listener", handler=failing_handler, topic="test.events"
        )
...
class TestEventFilter:
    ...
    def test_filter_creation(self):
        ...
        event_filter = EventFilter(
            name="test_filter", filter_func=filter_func, topic="test.events"
        )
    ...
    def test_filter_application(self):
        ...
        event_filter = EventFilter(
            name="enabled_filter", filter_func=filter_func, topic="test.events"
        )

        # Should pass
        payload1 = EventPayload(
            topic="test.events", data={"enabled": True}, timestamp=datetime.now()
        )
        assert event_filter.apply(payload1) is True

        # Should not pass
        payload2 = EventPayload(
            topic="test.events", data={"enabled": False}, timestamp=datetime.now()
        )
...
class TestRetryPolicy:
    ...
    def test_retry_policy_creation(self):
        ...
        policy = RetryPolicy(
            max_attempts=3, backoff_seconds=1.0, max_backoff_seconds=10.0
        )
...
class TestDispatchResult:
    ...
    def test_result_aggregation(self):
        ...
        result1 = DispatchResult(
            success=True, topic="test.events", listeners_reached=2, listeners_failed=0
        )
        result2 = DispatchResult(
            success=True, topic="test.events", listeners_reached=3, listeners_failed=1
        )
