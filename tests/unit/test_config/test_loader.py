...
class TestConfigLoader:
    ...
    def test_config_layered_loading(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".yaml", delete=False) as f:
            config_data = {"server_name": "YAML Config", "log_level": "WARNING"}
            yaml.dump(config_data, f)
            temp_path = f.name
    ...
    def test_config_profile_specific_settings(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".yaml", delete=False) as f:
            config_data = {
                "profile": "production",
                "profiles": {
                    "production": {"log_level": "ERROR", "debug": False},
                    "development": {"log_level": "DEBUG", "debug": True},
                },
            }
            yaml.dump(config_data, f)
            temp_path = f.name
...
class TestOneiricSettings:
    ...
    def test_settings_custom_values(self):
        ...
        settings = OneiricSettings(
            server_name="Custom Server", log_level="DEBUG", profile="development"
        )
    ...
    def test_settings_from_dict(self):
        ...
        config_dict = {"server_name": "Dict Server", "log_level": "WARNING"}
    ...
    def test_settings_to_dict(self):
        ...
        settings = OneiricSettings(server_name="Export Server", log_level="INFO")
    ...
    def test_settings_json_serialization(self):
        ...
        settings = OneiricSettings(server_name="JSON Server", log_level="ERROR")
