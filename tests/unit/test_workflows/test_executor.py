...
class TestWorkflowDAG:
    ...
    def test_dag_add_node(self):
        ...
        node = WorkflowNode(
            id="node1", name="Test Node", handler="test.handler", config={"timeout": 30}
        )
...
class TestWorkflowExecutor:
    ...
    def test_execute_workflow_success(self, executor, simple_dag):
        ...
        context = WorkflowContext(workflow_id="simple", input_data={"test": "data"})
    ...
    def test_execute_workflow_with_checkpoints(self, executor, simple_dag):
        ...
        context = WorkflowContext(
            workflow_id="simple", input_data={}, enable_checkpoints=True
        )
    ...
    def test_execute_workflow_node_failure(self, executor, simple_dag):
        ...
        context = WorkflowContext(workflow_id="simple", input_data={})
    ...
    def test_execute_workflow_parallel_nodes(self, executor):
        ...
        context = WorkflowContext(workflow_id="parallel", input_data={})
...
class TestCheckpointManager:
    ...
    def test_create_checkpoint(self, manager):
        ...
        checkpoint = manager.create(
            workflow_id="test_workflow", node_id="node_a", data={"output": "result"}
        )
    ...
    def test_checkpoint_persistence(self, manager):
        ...
        checkpoint = manager.create("test_workflow", "node_a", {"output": "result"})
...
class TestWorkflowError:
    ...
    def test_workflow_error_creation(self):
        ...
        error = WorkflowError(
            message="Test workflow error", workflow_id="test_workflow", node_id="node_a"
        )
    ...
    def test_workflow_validation_error(self):
        ...
        error = WorkflowValidationError(
            message="Invalid DAG structure", workflow_id="invalid_workflow"
        )
