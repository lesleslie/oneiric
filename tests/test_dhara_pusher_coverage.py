"""Tests for oneiric/adapters/dhara_pusher.py — DharaAdapterPusher, push_adapters_on_startup, main."""
...
# ---------------------------------------------------------------------------
# DharaAdapterPusher.__init__
# ---------------------------------------------------------------------------


class TestPusherInit:
    def test_init_defaults(self):
        p = DharaAdapterPusher()
        assert p.dhara_url == "http://127.0.0.1:8683"
        assert p.timeout == 30.0

    def test_init_custom_url(self):
        p = DharaAdapterPusher(dhara_url="http://example.com:9999")
    ...
    def test_init_custom_timeout(self):
        p = DharaAdapterPusher(timeout=60.0)
