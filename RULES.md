...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and oneiric through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through oneiric
  - The ultimate goal is to run `python -m oneiric -x -t` without any errors
...
- **Test Coverage Improvement (MANDATORY)**
  ...
  - **Maintain high test coverage**: Oneiric maintains 83% coverage with 526+ passing tests. Never reduce existing coverage.
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_oneiric`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m oneiric --comprehensive`
