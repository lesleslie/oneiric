...
2. `test_raindrop_runtime_integration.py` - Raindrop.io runtime tests
3. `test_excalidraw_runtime_simple.py` - Excalidraw component tests
...
2. **MIGRATION_COMPLETE_SUMMARY.md** - Final completion report
3. **MCP_SERVER_MIGRATION_PLAN.md** - Original migration plan
4. **MIGRATION_BASELINE_AUDIT_mailgun-mcp.md** - Baseline audit
5. **MIGRATION_CHECKLIST_TEMPLATE.md** - Migration checklist template
6. **MIGRATION_TRACKING_DASHBOARD.md** - Progress tracking
7. **CLI_COMMAND_MAPPING_GUIDE.md** - CLI migration guide
8. **TEST_COVERAGE_BASELINES.md** - Test coverage documentation
9. **ROLLBACK_PROCEDURES_TEMPLATE.md** - Rollback procedures
10. **OPERATIONAL_MODEL_DOCUMENTATION.md** - Operational model
11. **COMPATIBILITY_CONTRACT.md** - Compatibility contract
12. **ACB_REMOVAL_INVENTORY.md** - ACB removal inventory

## 🎯 Key Technical Decisions

1. **No Legacy Support**: Remove all ACB patterns and legacy CLI flags
2. **Standardized CLI Interface**: Use subcommand syntax (start, stop, health, config)
3. **Health Schema Compliance**: Use mcp-common health primitives and Session-Buddy contracts
4. **Runtime Cache Implementation**: Implement `.oneiric_cache/` with PID files and snapshots
5. **Instance Isolation Support**: Support `--instance-id` for multi-instance deployments
