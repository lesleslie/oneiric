...
> **Status:** Production Ready (audit v0.2.0, current v0.16.2) — see `docs/implementation/STAGE5_FINAL_AUDIT_REPORT.md` for audit metrics and `coverage.json` for the latest coverage snapshot.
...
- [Why Oneiric](#why-oneiric)
- [Domain Coverage & Built-ins](#domain-coverage--built-ins)
- [CLI Usage](#cli-usage)
- [Remote Manifests](#remote-manifests)
